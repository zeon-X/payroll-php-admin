        ...
        <section class="my-20 py-4">
            ...
            <div class=" mt-10 mx-auto grid grid-cols-3 justify-center items-center gap-8">
                ...
                <div class="flex flex-col justify-center items-center hover:mt-[-30px] transition-all ease-in-out">
                    <img src="https://i.ibb.co/NNPM7jC/140874310-1633845690150580-9052359744013760753-n.jpg" alt=""
                        class="w-[280px] h-[280px] rounded-full shadow-lg mb-4" />
                    <p>ID: 1903143</p>
                </div>
                <div class=" flex flex-col justify-center items-center hover:mt-[-30px] transition-all ease-in-out">
                    <img src="https://i.ibb.co/7pSn4mm/316246385-434968045506288-2865891230623973497-n.jpg" alt=""
                        class="w-[280px] h-[280px] rounded-full shadow-lg mb-4" />
                    <p>ID: 1903144</p>
                </div>
                <div class="flex flex-col justify-center items-center hover:mt-[-30px] transition-all ease-in-out">
                    <img src="https://i.ibb.co/SxCWKDH/imgonline-com-ua-resize-B8x-PNPFMy-T8-CMumt.jpg" alt=""
                        class="w-[280px] h-[280px] rounded-full shadow-lg mb-4" />
                    <p>ID: 1903147</p>
                </div>
                <div class="flex flex-col justify-center items-center hover:mt-[-30px] transition-all ease-in-out">
                ...
                <div class=" flex flex-col justify-center items-center hover:mt-[-30px] transition-all ease-in-out">
                    <img src="https://i.ibb.co/6PS8NVz/322703713-1366806297478294-4637059878375866967-n.jpg" alt=""
                        class="w-[280px] h-[280px] rounded-full shadow-lg mb-4" />
                    <p>ID: 1903149</p>
                </div>
                <div class="flex flex-col justify-center items-center hover:mt-[-30px] transition-all ease-in-out">
